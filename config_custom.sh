...
rm -rf cellxgene
git clone https://github.com/Mye-InfoBank/cellxgene.git
cd cellxgene
...
git checkout f966f99c31e92eaf9beba548ef249e4b4016b155 # v1.2.0 with custom support for embeddings for varying sizes
